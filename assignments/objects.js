...
const parent = {
  name: 'Susan',
  age: '70',
  parentspeak: () => `Hello, I'm the parent ${parent.name}!!`,
  child: {
    name: 'George',
    age: 50,
    childspeak: () => `Hello, I'm the child ${parent.child.name}!!`,
    grandchild: {
      name: 'Sam',
      age: 30,
      grandchildspeak: () => `Hello, I'm the grandchild ${parent.child.grandchild.name}!!`
    }
  }
}
